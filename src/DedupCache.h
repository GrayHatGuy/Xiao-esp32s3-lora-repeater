...
// "[MT]/[MC]/[rns]" text marker (ROUTING-REDESIGN.md §3.1).
//
...
// mutex — a sibling of NodeDB, same concurrency model (multiple radio tasks
// may call in from the quad routing matrix). Entries are tiny (8 B), so the
// table lives in internal RAM, not PSRAM.
// ---------------------------------------------------------------------------
