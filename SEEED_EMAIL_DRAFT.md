...
The contest entry (issue #2 in `Seeed-Projects/meshtastic-build-off-2026`) is a multi-protocol LoRa mesh bridge. The host MCU is Seeed Xiao ESP32-S3.

- **Phase 0** — Two Wio-SX1262 modules. Production-stable. Released as v8.1. This is the contest deliverable.
